...
2. `2026-02-20__fix-invalid-docs-path-in-self-improvement-spec`
- 状態: planned
- 計画段階: plan-draft
- ゲート状態: plan-ready
- 依存: なし
...
3. `2026-02-20__add-plan-template-and-index-link`
- 状態: planned
- 計画段階: plan-draft
- ゲート状態: plan-ready
- 依存: なし
...
1. `2026-02-20__fix-improvement-create-task-dependency-placeholder`
- 状態: done
...
2. `2026-02-20__allow-schema-governance-without-base-sha`
- 状態: done
- 依存: なし
- 依存状態: なし
...
3. `2026-02-20__align-workflow-dispatch-task-id-contract`
- 状態: done
- 依存: なし
- 依存状態: なし
...
4. `2026-02-20__fix-improvement-create-task-parser-errors`
- 状態: done
- 依存: なし
- 依存状態: なし
...
5. `2026-02-19__ci-profile-schema-version-governance-gate`
- 状態: done
- 依存: なし
- 依存状態: なし
...
6. `2026-02-19__rail10-skill-command-path-fix`
- 状態: done
...
7. `2026-02-19__task-doc-prerequisite-knowledge-section`
- 状態: done
- 依存: `2026-02-19__task-dependency-aware-prioritization-flow`
- 依存状態: 解決済み
...
8. `2026-02-19__task-dependency-aware-prioritization-flow`
- 状態: done
- 依存: なし
- 依存状態: なし
...
11. `2026-02-19__state-validator-history-strategy`
- 状態: done
...
12. `2026-02-19__profile-validator-schema-version-field`
- 状態: done
...
13. `2026-02-19__state-validator-done-docs-index-consistency`
- 状態: done
...
14. `2026-02-19__profile-validator-required-checks-source-of-truth`
- 状態: done
...
25. `2026-02-18__self-improvement-loop-enforcement`
- 状態: done
- 目的: Process Findings + 改善起票強制 + CI 改善ゲート導入
- 参照: `work/2026-02-18__self-improvement-loop-enforcement/spec.md`

26. `2026-02-19__existing-docs-prerequisites-retrofit`
- 状態: done
...
27. `2026-02-20__dependency-gate-before-plan-flow`
- 状態: done
...
28. `2026-02-20__plan-draft-before-kickoff-commit-flow`
- 状態: done
...
29. `2026-02-20__subagent-multi-agent-delegation-governance`
- 状態: done
