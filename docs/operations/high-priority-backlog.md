...
5. `2026-02-19__profile-validator-schema-version-field`
- 状態: done
...
6. `2026-02-19__state-validator-done-docs-index-consistency`
- 状態: done
...
7. `2026-02-19__profile-validator-required-checks-source-of-truth`
- 状態: done
...
18. `2026-02-18__self-improvement-loop-enforcement`
- 状態: done
