...
1. `2026-02-19__profile-validator-schema-version-field`
- 状態: planned
...
1. `2026-02-19__state-validator-done-docs-index-consistency`
- 状態: done
...
2. `2026-02-19__profile-validator-required-checks-source-of-truth`
- 状態: done
...
4. `2026-02-18__consistency-check-all-tasks-exclusion-rules`
- 状態: done
- 目的: `-AllTasks` 実行時の除外条件（archive/legacy）を定義する
- 参照: `work/2026-02-18__consistency-check-all-tasks-exclusion-rules/spec.md`

5. `2026-02-18__consistency-check-json-schema-version-policy`
- 状態: done
...
13. `2026-02-18__self-improvement-loop-enforcement`
- 状態: done
