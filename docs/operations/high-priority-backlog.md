...
3. `2026-02-19__task-dependency-aware-prioritization-flow`
- 状態: done
- 依存: なし
- 依存状態: なし
...
6. `2026-02-19__state-validator-history-strategy`
- 状態: done
...
7. `2026-02-19__profile-validator-schema-version-field`
- 状態: done
...
8. `2026-02-19__state-validator-done-docs-index-consistency`
- 状態: done
...
9. `2026-02-19__profile-validator-required-checks-source-of-truth`
- 状態: done
...
20. `2026-02-18__self-improvement-loop-enforcement`
- 状態: done
