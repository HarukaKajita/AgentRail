...
| VE-006 | profile-validator | `work/2026-02-19__profile-version-schema-version-unification-strategy/review.md` | `schema_version` 更新運用（2.x 以降）を CI で強制し、更新漏れ・不整合を fail-fast で検出する。 | high | done | `2026-02-19__ci-profile-schema-version-governance-gate` |
