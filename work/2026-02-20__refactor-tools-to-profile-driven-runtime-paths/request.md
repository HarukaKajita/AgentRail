# Request: 2026-02-20__refactor-tools-to-profile-driven-runtime-paths
...
- 直要求:
  - work/docs 直書きを廃止し、.agentrail/work レイアウトでも同一挙動にする。
...
- depends_on: `2026-02-20__add-runtime-installer-with-agentrail-work-layout`
- 依存状態: 未解決（先行タスク完了待ち）

## 成功条件（要望レベル）

1. work/2026-02-20__refactor-tools-to-profile-driven-runtime-paths/spec.md に具体要件と受入条件が定義される。
2. work/2026-02-20__refactor-tools-to-profile-driven-runtime-paths/plan.md に plan-draft / depends_on gate / plan-final が定義される。
