...
- 検証順序:
  1. `pwsh -NoProfile -File tools/state-validate/validate.ps1 -TaskId 2026-02-20__refactor-tools-to-profile-driven-runtime-paths`
  2. `pwsh -NoProfile -File tools/consistency-check/check.ps1 -TaskId 2026-02-20__refactor-tools-to-profile-driven-runtime-paths`
  3. 影響範囲の回帰チェック
...
- 受入条件の判定結果を `work/2026-02-20__refactor-tools-to-profile-driven-runtime-paths/review.md` に記録する。
