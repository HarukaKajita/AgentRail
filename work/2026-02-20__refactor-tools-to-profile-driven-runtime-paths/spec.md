# 仕様書: 2026-02-20__refactor-tools-to-profile-driven-runtime-paths
...
- 参照資料:
  ...
  - `work/2026-02-20__refactor-tools-to-profile-driven-runtime-paths/investigation.md`
- 理解ポイント:
...
- 更新日: 2026-02-20
- 作成者: codex
- 関連要望: work/2026-02-20__refactor-tools-to-profile-driven-runtime-paths/request.md
...
- consistency/state/resolve/improvement/commit-boundary のパス解決改修
- workflow.task_root/docs_root/runtime_root 参照統一
- 既存 CI での後方互換確認
...
- investigation: work/2026-02-20__refactor-tools-to-profile-driven-runtime-paths/investigation.md
- plan: work/2026-02-20__refactor-tools-to-profile-driven-runtime-paths/plan.md
- review: work/2026-02-20__refactor-tools-to-profile-driven-runtime-paths/review.md
- docs:
