# Investigation: 2026-02-20__wave1-migrate-core-docs-to-human-centric-model
...
- 理解ポイント:
  - Wave 1: AGENTS/README/INDEX を情報モデルへ移行 の実行順序は wave 計画と depends_on に従う。

## 1. 調査対象 (Investigation Target) (必須)

- 課題: `AGENTS.md`、`README.md`、`docs/INDEX.md` を人間理解中心の情報モデルへ適合させる。
...
- 事実:
  - Wave 1: AGENTS/README/INDEX を情報モデルへ移行 は wave 計画の分割単位として必要。
...
- Wave 1: AGENTS/README/INDEX を情報モデルへ移行 を単独タスクとして起票し、wave 依存順序を維持して進行する。
...
- spec: `work/2026-02-20__wave1-migrate-core-docs-to-human-centric-model/spec.md`
