...
- 理解ポイント:
  - Wave 1: AGENTS/README/INDEX を情報モデルへ移行 は wave 計画に基づく実行タスクである。

## 要望の原文

- `AGENTS.md`、`README.md`、`docs/INDEX.md` を人間理解中心の情報モデルへ適合させる。
- wave 計画の依存順序を維持し、品質ゲートを満たす成果物を作成する。

## 要望分析

- 直要求:
  - Wave 1: AGENTS/README/INDEX を情報モデルへ移行 の成果物を定義し、task 一式へ反映する。
...
1. Wave 1: AGENTS/README/INDEX を情報モデルへ移行 の成果物が task 資料と関連 docs に明文化される。
