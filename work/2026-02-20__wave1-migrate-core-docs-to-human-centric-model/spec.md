...
- **合格基準**: consistency-check -TaskId 2026-02-20__wave1-migrate-core-docs-to-human-centric-model が PASS
...
- **検証手順**: `AGENTS.md` / `README.md` / `docs/INDEX.md` の導線見出しと関連リンクを確認する
