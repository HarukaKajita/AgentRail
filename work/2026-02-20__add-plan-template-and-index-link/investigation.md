# Investigation: 2026-02-20__add-plan-template-and-index-link
...
- 課題: plan.md は必須成果物だが docs/templates に plan テンプレート導線がない。
- 優先度: medium
- カテゴリ: docs
...
- spec: `work/2026-02-20__add-plan-template-and-index-link/spec.md`
