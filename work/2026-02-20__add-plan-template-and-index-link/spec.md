# 仕様書: 2026-02-20__add-plan-template-and-index-link
...
- 参照資料:
  - `AGENTS.md`
  - `docs/INDEX.md`
  - `work/2026-02-20__add-plan-template-and-index-link/request.md`
  - `work/2026-02-20__add-plan-template-and-index-link/investigation.md`
- 理解ポイント:
...
- 更新日: 2026-02-20
- 作成者: codex
- 関連要望: `work/2026-02-20__add-plan-template-and-index-link/request.md`

## 2. 背景と目的 (Background & Objectives) (必須)

- 背景: Repository review で "plan.md は必須成果物だが docs/templates に plan テンプレート導線がない。" が検出された。
...
- AC-001: "plan.md は必須成果物だが docs/templates に plan テンプレート導線がない。" を再現できなくなる。
...
- request: `work/2026-02-20__add-plan-template-and-index-link/request.md`
- investigation: `work/2026-02-20__add-plan-template-and-index-link/investigation.md`
- plan: `work/2026-02-20__add-plan-template-and-index-link/plan.md`
- review: `work/2026-02-20__add-plan-template-and-index-link/review.md`
- docs:
