# Request: 2026-02-20__plan-runtime-package-distribution-migration
...
- 直要求:
  - 実施時期未定の package 化に備え、移行条件・互換ポリシー・実装ステップを先行定義する。
...
1. work/2026-02-20__plan-runtime-package-distribution-migration/spec.md に具体要件と受入条件が定義される。
2. work/2026-02-20__plan-runtime-package-distribution-migration/plan.md に plan-draft / depends_on gate / plan-final が定義される。
