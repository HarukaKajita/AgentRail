# Investigation: 2026-02-20__add-sidecar-log-rule-to-visual-guide
...
- 課題: 可視化ガイドの委譲契約に sidecar 監査ログ要件が欠落している。
- 優先度: medium
- カテゴリ: docs
...
- spec: `work/2026-02-20__add-sidecar-log-rule-to-visual-guide/spec.md`
