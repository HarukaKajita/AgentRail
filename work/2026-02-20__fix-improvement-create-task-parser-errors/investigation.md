# Investigation: 2026-02-20__fix-improvement-create-task-parser-errors
...
- 課題: tools/improvement-harvest/create-task.ps1 が PowerShell 構文エラーで実行できない。
- 優先度: critical
- カテゴリ: quality
...
- spec: `work/2026-02-20__fix-improvement-create-task-parser-errors/spec.md`
