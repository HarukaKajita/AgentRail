# Request: 2026-02-20__wave2-spec-doc-quality-check-rules
...
- 理解ポイント:
  - Wave 2: docs品質チェックルール設計 は wave 計画に基づく実行タスクである。

## 要望の原文

- consistency-check / state-validate へ追加する docs 品質チェック仕様を設計する。
- wave 計画の依存順序を維持し、品質ゲートを満たす成果物を作成する。

## 要望分析

- 直要求:
  - Wave 2: docs品質チェックルール設計 の成果物を定義し、task 一式へ反映する。
...
1. Wave 2: docs品質チェックルール設計 の成果物が task 資料と関連 docs に明文化される。
