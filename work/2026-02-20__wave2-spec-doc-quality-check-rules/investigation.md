# Investigation: 2026-02-20__wave2-spec-doc-quality-check-rules
...
- 理解ポイント:
  - Wave 2: docs品質チェックルール設計 の実行順序は wave 計画と depends_on に従う。

## 1. 調査対象 [空欄禁止]

- 課題: consistency-check / state-validate へ追加する docs 品質チェック仕様を設計する。
...
- 事実:
  - Wave 2: docs品質チェックルール設計 は wave 計画の分割単位として必要。
  - depends_on は 未解決（2026-02-20__wave1-normalize-doc-work-cross-links[planned]）。
- 推測:
...
- Wave 2: docs品質チェックルール設計 を単独タスクとして起票し、wave 依存順序を維持して進行する。
...
- spec: `work/2026-02-20__wave2-spec-doc-quality-check-rules/spec.md`
