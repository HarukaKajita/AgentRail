...
- 理解ポイント:
  - Wave 2: docs品質チェックルール設計 は wave 計画を実行するための分割タスクである。
...
- AC-001: Wave 2: docs品質チェックルール設計 の成果物・手順・ゲート・ロールバックが task 資料に明記される。
...
- 影響ファイル/モジュール: `work/2026-02-20__wave2-spec-doc-quality-check-rules`/*, `docs/operations/high-priority-backlog.md`, `MEMORY.md`
