# 仕様書: 2026-02-20__normalize-remaining-investigation-heading-terms
...
- 参照資料:
  ...
  - `work/2026-02-20__normalize-remaining-investigation-heading-terms/investigation.md`
- 理解ポイント:
...
- 更新日: 2026-02-20
- 作成者: codex
- 関連要望: `work/2026-02-20__normalize-remaining-investigation-heading-terms/request.md`

## 2. 背景と目的 (Background & Objectives) (必須)

- 背景: Repository review で "一部 investigation.md が併記方針（調査方法/調査結果）へ未統一。" が検出された。
...
- AC-001: "一部 investigation.md が併記方針（調査方法/調査結果）へ未統一。" を再現できなくなる。
...
- investigation: `work/2026-02-20__normalize-remaining-investigation-heading-terms/investigation.md`
- plan: `work/2026-02-20__normalize-remaining-investigation-heading-terms/plan.md`
- review: `work/2026-02-20__normalize-remaining-investigation-heading-terms/review.md`
- docs:
