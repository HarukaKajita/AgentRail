...
- 理解ポイント:
  - Wave 2: CI runbook と docs品質ゲート整合 は wave 計画を実行するための分割タスクである。
...
- AC-001: Wave 2: CI runbook と docs品質ゲート整合 の成果物・手順・ゲート・ロールバックが task 資料に明記される。
...
- 対象: `work/2026-02-20__wave2-align-ci-runbook-with-doc-quality-gates` の request/investigation/spec/plan/review/state
- 観点: 空欄禁止セクション、依存、成果物定義の整合
- 合格条件: consistency-check -TaskId 2026-02-20__wave2-align-ci-runbook-with-doc-quality-gates が PASS
...
- 影響ファイル/モジュール: `work/2026-02-20__wave2-align-ci-runbook-with-doc-quality-gates`/*, `docs/operations/high-priority-backlog.md`, `MEMORY.md`
