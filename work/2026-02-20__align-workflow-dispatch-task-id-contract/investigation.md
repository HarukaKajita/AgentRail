# Investigation: 2026-02-20__align-workflow-dispatch-task-id-contract
...
- 課題: workflow_dispatch の task_id optional 設定と resolver の必須判定が矛盾している。
- 優先度: high
- カテゴリ: ci
...
- spec: `work/2026-02-20__align-workflow-dispatch-task-id-contract/spec.md`
