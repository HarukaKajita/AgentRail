...
- 理解ポイント:
  - Wave 2: docs品質チェック fail 昇格 は wave 計画を実行するための分割タスクである。
...
- AC-001: Wave 2: docs品質チェック fail 昇格 の成果物・手順・ゲート・ロールバックが task 資料に明記される。
...
- 対象: `work/2026-02-20__wave2-enforce-doc-quality-fail-mode` の request/investigation/spec/plan/review/state
- 観点: 空欄禁止セクション、依存、成果物定義の整合
- 合格条件: consistency-check -TaskId 2026-02-20__wave2-enforce-doc-quality-fail-mode が PASS
...
- 影響ファイル/モジュール: `work/2026-02-20__wave2-enforce-doc-quality-fail-mode`/*, `docs/operations/high-priority-backlog.md`, `MEMORY.md`
