...
- 理解ポイント:
  - Wave 3: KPI と Process Findings 連携 の実行順序は wave 計画と depends_on に従う。

## 1. 調査対象 [空欄禁止]

- 課題: KPI悪化時に Process Findings から改善タスクへ接続する運用を定義する。
...
- 事実:
  - Wave 3: KPI と Process Findings 連携 は wave 計画の分割単位として必要。
  - depends_on は 未解決（2026-02-20__wave3-automate-doc-quality-metrics-report[planned]）。
- 推測:
...
- Wave 3: KPI と Process Findings 連携 を単独タスクとして起票し、wave 依存順序を維持して進行する。
