...
- `pwsh -NoProfile -File tools/consistency-check/check.ps1 -TaskId 2026-02-20__allow-schema-governance-without-base-sha`
- `pwsh -NoProfile -File tools/state-validate/validate.ps1 -TaskId 2026-02-20__allow-schema-governance-without-base-sha`
- `pwsh -NoProfile -File tools/docs-indexer/index.ps1 -Mode check`

## 6. 完了判定

- AC-001 から AC-003 が `work/2026-02-20__allow-schema-governance-without-base-sha/review.md` で PASS になる。
