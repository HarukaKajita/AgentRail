# Request: 2026-02-20__split-framework-runtime-rules-from-agents
...
1. work/2026-02-20__split-framework-runtime-rules-from-agents/spec.md に具体要件と受入条件が定義される。
2. work/2026-02-20__split-framework-runtime-rules-from-agents/plan.md に plan-draft / depends_on gate / plan-final が定義される。
