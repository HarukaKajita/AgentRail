# Request: 2026-02-20__define-runtime-manifest-and-export-flow
...
- 直要求:
  - 配布対象を allowlist 化し、外部利用時に不要な開発用ファイル混入を防止する。
...
1. work/2026-02-20__define-runtime-manifest-and-export-flow/spec.md に具体要件と受入条件が定義される。
2. work/2026-02-20__define-runtime-manifest-and-export-flow/plan.md に plan-draft / depends_on gate / plan-final が定義される。
