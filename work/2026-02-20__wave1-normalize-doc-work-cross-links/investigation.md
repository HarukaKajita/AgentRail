# Investigation: 2026-02-20__wave1-normalize-doc-work-cross-links
...
- 理解ポイント:
  - Wave 1: docs-work 相互リンク正規化 の実行順序は wave 計画と depends_on に従う。

## 1. 調査対象 (Investigation Target) (必須)

- 課題: docs と work の相互参照を統一し、参照切れを解消する。
...
- 事実:
  - Wave 1: docs-work 相互リンク正規化 は wave 計画の分割単位として必要。
  - depends_on は 未解決（2026-02-20__wave1-migrate-core-docs-to-human-centric-model[planned], 2026-02-20__wave1-migrate-operations-docs-to-human-centric-model[planned]）。
- 推測:
...
- Wave 1: docs-work 相互リンク正規化 を単独タスクとして起票し、wave 依存順序を維持して進行する。
...
- spec: `work/2026-02-20__wave1-normalize-doc-work-cross-links/spec.md`
