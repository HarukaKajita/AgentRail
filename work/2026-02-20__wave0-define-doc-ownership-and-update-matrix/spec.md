...
- 理解ポイント:
  - Wave 0: docs更新責務マトリクス定義 は wave 計画を実行するための分割タスクである。
...
- AC-001: Wave 0: docs更新責務マトリクス定義 の成果物・手順・ゲート・ロールバックが task 資料に明記される。
...
- 影響ファイル/モジュール: `work/2026-02-20__wave0-define-doc-ownership-and-update-matrix`/*, `docs/operations/high-priority-backlog.md`, `MEMORY.md`
