# Investigation: 2026-02-20__wave0-define-doc-ownership-and-update-matrix
...
- 理解ポイント:
  - Wave 0: docs更新責務マトリクス定義 の実行順序は wave 計画と depends_on に従う。

## 1. 調査対象 (Investigation Target) (必須)

- 課題: task owner / implementation owner / reviewer の責務を資料単位で定義する。
...
- 事実:
  - Wave 0: docs更新責務マトリクス定義 は wave 計画の分割単位として必要。
...
- Wave 0: docs更新責務マトリクス定義 を単独タスクとして起票し、wave 依存順序を維持して進行する。
...
- spec: `work/2026-02-20__wave0-define-doc-ownership-and-update-matrix/spec.md`
