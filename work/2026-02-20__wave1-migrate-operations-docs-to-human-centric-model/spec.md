...
- **合格基準**: consistency-check -TaskId 2026-02-20__wave1-migrate-operations-docs-to-human-centric-model が PASS
...
- **検証手順**: 対象 operations docs に追加した導線セクションと migration 記録 docs を確認
