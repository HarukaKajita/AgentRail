# 仕様書: 2026-02-20__fix-invalid-docs-path-in-self-improvement-spec
...
- 参照資料:
  ...
  - `work/2026-02-20__fix-invalid-docs-path-in-self-improvement-spec/investigation.md`
- 理解ポイント:
...
- 更新日: 2026-02-20
- 作成者: codex
- 関連要望: `work/2026-02-20__fix-invalid-docs-path-in-self-improvement-spec/request.md`

## 2. 背景と目的 (Background & Objectives) (必須)

- 背景: Repository review で "self-improvement-loop spec に実在しない docs パス記述がある。" が検出された。
...
- AC-001: "self-improvement-loop spec に実在しない docs パス記述がある。" を再現できなくなる。
...
- request: `work/2026-02-20__fix-invalid-docs-path-in-self-improvement-spec/request.md`
- investigation: `work/2026-02-20__fix-invalid-docs-path-in-self-improvement-spec/investigation.md`
- plan: `work/2026-02-20__fix-invalid-docs-path-in-self-improvement-spec/plan.md`
- review: `work/2026-02-20__fix-invalid-docs-path-in-self-improvement-spec/review.md`
- docs:
