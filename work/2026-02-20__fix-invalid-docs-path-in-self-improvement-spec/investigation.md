# Investigation: 2026-02-20__fix-invalid-docs-path-in-self-improvement-spec
...
- 課題: self-improvement-loop spec に実在しない docs パス記述がある。
- 優先度: medium
- カテゴリ: docs
...
- spec: `work/2026-02-20__fix-invalid-docs-path-in-self-improvement-spec/spec.md`
