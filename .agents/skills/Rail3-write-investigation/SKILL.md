...
description: work/<task-id>/investigation.md を作成・更新し、仮説・調査・観測方法・調査・観測結果・結論を事実ベースで確定する。判断不能点は確認質問2-4件と blocked 提案で扱う。
---
...
1. 調査対象と仮説を明確化する。
2. 調査・観測方法を具体化し、確認対象ファイルやコマンドを定義する。
3. 調査・観測結果を「事実」と「推測」に分離して記録する。
4. 提案オプションを3案作る（最小変更 / バランス / 強化）。
5. 推奨案を1つ選び、採用理由を記載する。
6. 結論、未解決事項、次のアクションを確定する。
